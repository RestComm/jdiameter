...
public abstract class AbstractClient extends TBase implements ClientSLgSessionListener {
  ...
  public void init(InputStream configStream, String clientID) throws Exception {
    try {
      ...
      this.clientSlgSession = ((ISessionFactory) this.sessionFactory)
          .getNewAppSession(this.sessionFactory.getSessionId("xxTESTxx"), getApplicationId(), ClientSLgSession.class, (Object) null);
    }
    finally {
      try {
        configStream.close();
