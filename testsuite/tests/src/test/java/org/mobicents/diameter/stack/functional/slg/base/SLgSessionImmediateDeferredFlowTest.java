...
public class SLgSessionImmediateDeferredFlowTest {
   ...
   * // @param serverCount
   */
  public SLgSessionImmediateDeferredFlowTest(String clientConfigUrl, String serverNode1ConfigURL) throws Exception {
    super();
  ...
  public static Collection<Object[]> data() {
    ...
    Class<SLgSessionImmediateDeferredFlowTest> t = SLgSessionImmediateDeferredFlowTest.class;
