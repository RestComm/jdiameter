 ...
 */
public class ProvideLocationAnswerImpl extends AppAnswerEventImpl implements ProvideLocationAnswer {
   ...
   * @param resultCode
   */
  public ProvideLocationAnswerImpl(Request request, long vendorId, long resultCode) {
   ...
   * @param request
   */
  public ProvideLocationAnswerImpl(Request request) {
    super(request);
  }
