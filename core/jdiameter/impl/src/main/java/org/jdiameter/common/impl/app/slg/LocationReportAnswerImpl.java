 ...
 */
public class LocationReportAnswerImpl extends AppAnswerEventImpl implements LocationReportAnswer {
   ...
   * @param resultCode
   */
  public LocationReportAnswerImpl(Request request, long vendorId, long resultCode) {
   ...
   * @param request
   */
  public LocationReportAnswerImpl(Request request) {
    super(request);
  }
