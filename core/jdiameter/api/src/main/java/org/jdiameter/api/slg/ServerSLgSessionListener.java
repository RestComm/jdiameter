...
public interface ServerSLgSessionListener {
  ...
  public void doLocationReportAnswerEvent(ServerSLgSession session, LocationReportRequest request, LocationReportAnswer answer)throws InternalException, IllegalDiameterStateException, RouteException, OverloadException;
  
  /**
   * Notifies this SLgSessionEventListener that the ServerSLhSession has received non SLg message.
