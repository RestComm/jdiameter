...
/**
 * The Location-Report-Request (LRR) command, indicated by the Command-Code
 * field set to 8388621 and the "R" bit set in the Command Flags field, is sent
 * by the MME or SGSN in order to provide subscriber location data to the GMLC.
 * 
 *
