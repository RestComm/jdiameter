 ...
 */
public class SLhServerSessionDataReplicatedImpl extends AppSessionDataReplicatedImpl implements ISLhServerSessionData {
   ...
   * @param iface
   */
  public SLhServerSessionDataReplicatedImpl(Fqn<?> nodeFqn, MobicentsCluster mobicentsCluster) {
   ...
   * @param iface
   */
  public SLhServerSessionDataReplicatedImpl(String sessionId, MobicentsCluster mobicentsCluster) {
