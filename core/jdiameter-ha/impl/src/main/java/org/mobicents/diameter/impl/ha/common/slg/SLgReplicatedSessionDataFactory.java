...
import org.mobicents.diameter.impl.ha.client.slg.SLgClientSessionDataReplicatedImpl;
import org.mobicents.diameter.impl.ha.data.ReplicatedSessionDatasource;
import org.mobicents.diameter.impl.ha.server.slg.SLgServerSessionDataReplicatedImpl;
...
public class SLgReplicatedSessionDataFactory implements IAppSessionDataFactory<ISLgSessionData> {
  ...
  public ISLgSessionData getAppSessionData(Class<? extends AppSession> clazz, String sessionId) {
    if (clazz.equals(ClientSLgSession.class)) {
      SLgClientSessionDataReplicatedImpl data = new SLgClientSessionDataReplicatedImpl(sessionId, this.mobicentsCluster);
      return data;
    }
    else if (clazz.equals(ServerSLgSession.class)) {
      SLgServerSessionDataReplicatedImpl data = new SLgServerSessionDataReplicatedImpl(sessionId, this.mobicentsCluster);
      return data;
    }
