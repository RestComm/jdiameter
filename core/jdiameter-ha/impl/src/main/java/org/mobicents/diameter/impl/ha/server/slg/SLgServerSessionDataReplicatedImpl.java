 ...
 */
public class SLgServerSessionDataReplicatedImpl extends AppSessionDataReplicatedImpl implements ISLgServerSessionData {
   ...
   * @param iface
   */
  public SLgServerSessionDataReplicatedImpl(Fqn<?> nodeFqn, MobicentsCluster mobicentsCluster) {
   ...
   * @param iface
   */
  public SLgServerSessionDataReplicatedImpl(String sessionId, MobicentsCluster mobicentsCluster) {
