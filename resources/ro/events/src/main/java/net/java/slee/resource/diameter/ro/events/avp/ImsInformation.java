...
/**
 * Defines an interface representing the IMS-Information grouped AVP type. From the Diameter Ro Reference Point Protocol Details (3GPP TS 32.299 V7.1.0) specification: 7.2.37 IMS-Information AVP The IMS-Information AVP (AVP code 876) is of type Grouped. Its purpose is to allow the transmission of additional IMS service specific information elements. It has the following ABNF grammar: IMS-Information ::= AVP Header: 876 [ Event-Type ] [ Role-Of-Node ] { Node-Functionality } [ User-Session-ID ] [ Calling-Party-Address ] [ Called-Party-Address ] [ Time-Stamps ] * [ Application-Server-Information ] * [ Inter-Operator-Identifier ] [ IMS-Charging-Identifier ] * [ SDP-Session-Description ] * [ SDP-Media-Component ] [ Served-Party-IP-Address ] [ Server-Capabilities ] [ Trunk-Group-ID ] [ Bearer-Service ] [ Service-Id ] [ Service-Specific-Data ] * [ Message-Body ] [ Cause-Code ]
 */
public interface ImsInformation extends GroupedAvp{
     ...
     */
    abstract byte[] getServerCapabilities();
     ...
     */
    abstract void setServerCapabilities(byte[] serverCapabilities);
