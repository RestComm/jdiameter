 ...
 */
public class RfAvpFactoryImpl extends CreditControlAVPFactoryImpl implements RfAvpFactory {

  public RfAvpFactoryImpl(DiameterAvpFactory baseAvpFactory)
  {
