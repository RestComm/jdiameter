...
public class UsedServiceUnitAvpImpl extends GrantedServiceUnitAvpImpl implements UsedServiceUnitAvp{
  ...
  /*
   * (non-Javadoc)
   * @see net.java.slee.resource.diameter.cca.events.avp.UsedServiceUnitAvp#setTariffChangeUsage(net.java.slee.resource.diameter.cca.events.avp.TariffChangeUsageType)
   */
