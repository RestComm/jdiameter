...
public class FinalUnitIndicationAvpImpl extends GroupedAvpImpl implements FinalUnitIndicationAvp {
  ...
  /*
   * (non-Javadoc)
   * @see net.java.slee.resource.diameter.cca.events.avp.FinalUnitIndicationAvp#setFinalUnitAction(net.java.slee.resource.diameter.cca.events.avp.FinalUnitActionType)
   */
  ...
  /*
   * (non-Javadoc)
   * @see net.java.slee.resource.diameter.cca.events.avp.FinalUnitIndicationAvp#setRedirectServer(net.java.slee.resource.diameter.cca.events.avp.RedirectServerAvp)
   */
  ...
  /*
   * (non-Javadoc)
   * @see net.java.slee.resource.diameter.cca.events.avp.FinalUnitIndicationAvp#setRestrictionFilterRule(net.java.slee.resource.diameter.base.events.avp.IPFilterRuleAvp)
   */
  ...
  /*
   * (non-Javadoc)
   * @see net.java.slee.resource.diameter.cca.events.avp.FinalUnitIndicationAvp#setRestrictionFilterRules(net.java.slee.resource.diameter.base.events.avp.IPFilterRuleAvp[])
   */
