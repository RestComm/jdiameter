...
public class ServiceParameterInfoAvpImpl extends GroupedAvpImpl implements
	...
	public void setServiceParameterType(long serviceParameterType) {
		//AvpRepresentation avpRep = AvpDictionary.INSTANCE.getAvp(CreditControlAVPCodes.Service_Parameter_Type);
		//int mandatoryAvp = avpRep.getRuleMandatory().equals("mustnot") || avpRep.getRuleMandatory().equals("shouldnot") ? 0 : 1;
		//int protectedAvp = avpRep.getRuleProtected().equals("must") ? 1 : 0;
		
		//super.setAvpAsUInt32(CreditControlAVPCodes.Service_Parameter_Type, Long.valueOf(avpRep.getVendorId()).longValue(), serviceParameterType, mandatoryAvp==1, protectedAvp==1, true);
	...
	public void setServiceParameterValue(byte[] serviceParameterValue) {
		...
		//super.setAvpAsByteArray(CreditControlAVPCodes.Service_Parameter_Value, Long.valueOf(avpRep.getVendorId()).longValue(), serviceParameterValue, mandatoryAvp==1, protectedAvp==1, true);
