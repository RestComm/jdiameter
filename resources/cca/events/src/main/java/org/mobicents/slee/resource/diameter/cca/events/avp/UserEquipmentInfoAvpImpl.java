...
public class UserEquipmentInfoAvpImpl extends GroupedAvpImpl implements
	...
	public void setUserEquipmentInfoType(UserEquipmentInfoType type) {
		//AvpRepresentation avpRep = AvpDictionary.INSTANCE.getAvp(CreditControlAVPCodes.User_Equipment_Info_Type);
		//int mandatoryAvp = avpRep.getRuleMandatory().equals("mustnot") || avpRep.getRuleMandatory().equals("shouldnot") ? 0 : 1;
		//int protectedAvp = avpRep.getRuleProtected().equals("must") ? 1 : 0;
		
		//super.setAvpAsUInt32(CreditControlAVPCodes.User_Equipment_Info_Type, Long.valueOf(avpRep.getVendorId()).longValue(), type.getValue(), mandatoryAvp==1, protectedAvp==1, true);
	...
	public void setUserEquipmentInfoValue(byte[] value) {
		...
		//super.setAvpAsByteArray(CreditControlAVPCodes.User_Equipment_Info_Value, Long.valueOf(avpRep.getVendorId()).longValue(), value, mandatoryAvp==1, protectedAvp==1, true);
