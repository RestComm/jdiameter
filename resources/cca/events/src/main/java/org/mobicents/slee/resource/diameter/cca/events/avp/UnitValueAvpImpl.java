...
public class UnitValueAvpImpl extends GroupedAvpImpl implements UnitValueAvp {
	...
	public void setExpotent(int expotent) {
		...
		//AvpRepresentation avpRep = AvpDictionary.INSTANCE.getAvp(CreditControlAVPCodes.Exponent);
		//int mandatoryAvp = avpRep.getRuleMandatory().equals("mustnot") || avpRep.getRuleMandatory().equals("shouldnot") ? 0 : 1;
		//int protectedAvp = avpRep.getRuleProtected().equals("must") ? 1 : 0;
		//super.setAvpAsUInt32(CreditControlAVPCodes.Exponent, Long.getLong(avpRep.getVendorId()),expotent, mandatoryAvp==1, protectedAvp==1, true);
		super.setAvpAsUInt32(CreditControlAVPCodes.Exponent,expotent,  true);
	...
	public void setValueDigits(long digits) {
		...
		//int mandatoryAvp = avpRep.getRuleMandatory().equals("mustnot") || avpRep.getRuleMandatory().equals("shouldnot") ? 0 : 1;
		//int protectedAvp = avpRep.getRuleProtected().equals("must") ? 1 : 0;
		//super.setAvpAsUInt64(CreditControlAVPCodes.Exponent, Long.getLong(avpRep.getVendorId()),digits, mandatoryAvp==1, protectedAvp==1, true);
		super.setAvpAsUInt64(CreditControlAVPCodes.Exponent,digits, true, true);
