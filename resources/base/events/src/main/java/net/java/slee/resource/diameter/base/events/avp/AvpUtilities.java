...
public class AvpUtilities {
	...
	private static void performPreAddOperations(Message msg, int avpCode, long vendorId, AvpSet set) throws AvpNotAllowedException {
		if (msg == null) {
			...
			if (!validator.isAllowed(msg.getCommandCode(), msg.getApplicationId(), msg.isRequest(), avpCode, vendorId)) {
				throw new AvpNotAllowedException("Avp defined by code: " + avpCode + ", vendorId: " + vendorId + " is nto allowed in message - code: " + msg.getCommandCode() + ", appId: "
	...
	/**
	 * Returns an {@link AvpRepresentation} of the AVP with the given code and
	 * given Vendor-Id, if found.
	 * 
	 * @param avpCode
	 *            the code of the AVP
	 * @param vendorId
	...
	/**
	 * Adds AVP to {@link AvpSet} as String (Octet or UTF-8) with the given code
	 * and Base Vendor-Id (0).
	 * 
	 * @param avpCode
	 *            the code of the AVP
	 * @param isOctetString
	 *            if true added as OctetString type, otherwise as UTF8String
	 * @param set
	 *            the AvpSet to add AVP
	 * @param value
	 *            the value of the AVP to add
	 */
	...
	/**
	 * Adds AVP to {@link AvpSet} as String (Octet or UTF-8) with the given code
	 * and given Vendor-Id plus defined mandatory and protected flags.
	 * 
	 * @param avpCode
	 *            the code of the AVP
	 * @param vendorId
	 ...
	 *            the AvpSet to add AVP
	 * @param isMandatory
	 *            the value for the mandatory bit
	 * @param isProtected
	 *            the value for the protected bit
	 * @param value
	 *            the value of the AVP to add
	 */
	...
	/**
	 * Adds AVP to {@link AvpSet} as OctetString with the given code and Base
	 * Vendor-Id (0).
	 * 
	 * @param avpCode
	 *            the code of the AVP
	...
	/**
	 * Adds AVP to {@link AvpSet} as OctetString with the given code and given
	 * Vendor-Id.
	 * 
	 * @param avpCode
	 *            the code of the AVP
	...
	/**
	 * Adds AVP to {@link AvpSet} as OctetString with the given code and given
	 * Vendor-Id plus defined mandatory and protected flags.
	 * 
	 * @param avpCode
	 *            the code of the AVP
	 * @param vendorId
	...
	/**
	 * Adds AVP to {@link AvpSet} as UTF8String with the given code and Base
	 * Vendor-Id (0).
	 * 
	 * @param avpCode
	 *            the code of the AVP
	...
	/**
	 * Adds AVP to {@link AvpSet} as UTF8String with the given code and given
	 * Vendor-Id.
	 * 
	 * @param avpCode
	 *            the code of the AVP
	...
	/**
	 * Adds AVP to {@link AvpSet} as Unsigned32 with the given code and Base
	 * Vendor-Id (0).
	 * 
	 * @param avpCode
	 *            the code of the AVP
	...
	/**
	 * Adds AVP to {@link AvpSet} as Unsigned32 with the given code and given
	 * Vendor-Id.
	 * 
	 * @param avpCode
	 *            the code of the AVP
	...
	/**
	 * Adds AVP to {@link AvpSet} as Unsigned64 with the given code and Base
	 * Vendor-Id (0).
	 * 
	 * @param avpCode
	 *            the code of the AVP
	...
	/**
	 * Adds AVP to {@link AvpSet} as Unsigned64 with the given code and given
	 * Vendor-Id.
	 * 
	 * @param avpCode
	 *            the code of the AVP
	...
	/**
	 * Adds AVP to {@link AvpSet} as Integer32 with the given code and Base
	 * Vendor-Id (0).
	 * 
	 * @param avpCode
	 *            the code of the AVP
	...
	/**
	 * Adds AVP to {@link AvpSet} as Integer32 with the given code and given
	 * Vendor-Id.
	 * 
	 * @param avpCode
	 *            the code of the AVP
	...
	/**
	 * Adds AVP to {@link AvpSet} as Integer64 with the given code and Base
	 * Vendor-Id (0).
	 * 
	 * @param avpCode
	 *            the code of the AVP
	...
	/**
	 * Adds AVP to {@link AvpSet} as Integer64 with the given code and given
	 * Vendor-Id.
	 * 
	 * @param avpCode
	 *            the code of the AVP
	...
	/**
	 * Adds AVP to {@link AvpSet} as Float32 with the given code and Base
	 * Vendor-Id (0).
	 * 
	 * @param avpCode
	 *            the code of the AVP
	...
	/**
	 * Adds AVP to {@link AvpSet} as Float32 with the given code and given
	 * Vendor-Id.
	 * 
	 * @param avpCode
	 *            the code of the AVP
	...
	/**
	 * Adds AVP to {@link AvpSet} as Float64 with the given code and Base
	 * Vendor-Id (0).
	 * 
	 * @param msg
	 *            the message where AVP will be added to, for validation
	 *            purposes. if null, no validation is performed.
	 * @param avpCode
	 *            the code of the AVP
	 * @param set
	 *            the Vendor-Id of the AVP
	...
	/**
	 * Adds AVP to {@link AvpSet} as Float64 with the given code and given
	 * Vendor-Id.
	 * 
	 * @param avpCode
	 *            the code of the AVP
	 ...
	 * 
	 * @param the
	 *            message where AVP will be added to, for validation purposes.
	...
	/**
	 * Adds AVP to {@link AvpSet} as raw data with the given code and Base
	 * Vendor-Id (0).
	 * 
	 * @param avpCode
	 *            the code of the AVP
	...
	/**
	 * Adds AVP to {@link AvpSet} as raw data with the given code and given
	 * Vendor-Id.
	 * 
	 * @param avpCode
	 *            the code of the AVP
	...
	/**
	 * Adds AVP to {@link AvpSet} as Time with the given code and Base Vendor-Id
	 * (0).
	 * 
	 * @param avpCode
	 *            the code of the AVP
	...
	/**
	 * Adds AVP to {@link AvpSet} as Time with the given code and given
	 * Vendor-Id.
	 * 
	 * @param avpCode
	 *            the code of the AVP
	...
	/**
	 * Adds AVP to {@link AvpSet} as Grouped with the given code and Base
	 * Vendor-Id (0).
	 * 
	 * @param avpCode
	 *            the code of the AVP
	...
	/**
	 * Adds AVP to {@link AvpSet} as Grouped with the given code and given
	 * Vendor-Id.
	 * 
	 * @param avpCode
	 *            the code of the AVP
	 ...
	 * 
	 * @param avpCode
	 *            the code of the AVP to look for
	 * @param set
	 *            the set of AVPs where to look
	 * 
	 ...
	 *            the code of the AVP to look for
	 * @param vendorId
	 *            the Vendor-Id of the AVP to look for
	 * @param set
	 *            the set of AVPs where to look
	 * 
	 * @return an AVP with the given code and Vendor-Id, or null if none is
	 *         present.
	 */
	 ...
	 *            the code of the AVP to look for
	 * @param vendorId
	 *            the Vendor-Id of the AVP to be added
	 * @param avp
	 *            the AVP object
	 * @param set
	 *            the AvpSet where to add the AVP
	 */
	 ...
	 * 
	 * @param avpCode
	 *            the code of the AVP to be removed
	 * @param set
	 *            the AvpSet to remove the AVP from
	 */
